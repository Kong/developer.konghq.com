...
<!-- last-processed-sha: 12e664f8754173863c821eb84b685195682f4571 -->

## Week of 2026-09-14

### AI Gateway

- [Mistral AI with Kong AI Gateway](https://developer.konghq.com/cookbooks/mistral-ai-with-kong-ai-gateway/)
- [AI Nvidia Nemo Guardrail Policy](https://developer.konghq.com/ai-gateway/policies/ai-nvidia-nemo-guardrail/)

### Kong Gateway

- [How-to: Enforce entitlements on LLM traffic](https://developer.konghq.com/ai-gateway/v1/how-to/enforce-entitlements-on-llm-traffic/)
- [How-to: Get started with Entitlement Enforcement](https://developer.konghq.com/metering-and-billing/entitlement-enforcement/get-started/)
- [How-to: Configure dynamic plugin config with CEL in Kong Gateway](https://developer.konghq.com/gateway/configure-dynamic-plugin-config-with-cel/)
- [How-to: Dynamically set host based on the authenticated Principal with Datakit](https://developer.konghq.com/how-to/configure-oidc-datakit-host-routing-with-principals-metadata/)
- [How-to: Add metrics to a custom plugin](https://developer.konghq.com/custom-plugins/get-started/add-metrics/)
- [How-to: Verify a Datakit call node's TLS connection using a custom CA](https://developer.konghq.com/how-to/verify-datakit-call-with-custom-ca/)
- [Example: Allow by Principal metadata](https://developer.konghq.com/plugins/acl/examples/allow-when-principal-metadata/)
- [Example: Deny by Principal metadata](https://developer.konghq.com/plugins/acl/examples/deny-when-principal-metadata/)
- [Example: Compress messages before sending to Kafka](https://developer.konghq.com/plugins/confluent/examples/compress-messages/)
- [Example: Simple JSON encoding for Avro schemas](https://developer.konghq.com/plugins/confluent/examples/schema-registry-simple-json/)
- [Example: Sign JWT with Principal ID](https://developer.konghq.com/plugins/datakit/examples/sign-principal-jwt/)
- [Example: Verify TLS connection using a custom CA](https://developer.konghq.com/plugins/datakit/examples/verify-call-node-with-custom-ca/)
- [Example: Enforce entitlements by header, with a custom denial response](https://developer.konghq.com/plugins/entitlement-enforcement/examples/enforce-by-header-with-custom-response/)
- [Example: Enforce entitlements for a feature](https://developer.konghq.com/plugins/entitlement-enforcement/examples/enforce-entitlements-for-a-feature/)
- [Entitlement Enforcement](https://developer.konghq.com/plugins/entitlement-enforcement/)
- [Example: Compress log messages before sending to Kafka](https://developer.konghq.com/plugins/kafka-log/examples/compress-messages/)
- [Example: Simple JSON encoding for Avro schemas](https://developer.konghq.com/plugins/kafka-log/examples/schema-registry-simple-json/)
- [Example: Compress messages before sending to Kafka](https://developer.konghq.com/plugins/kafka-upstream/examples/compress-messages/)
- [Example: Simple JSON encoding for Avro schemas](https://developer.konghq.com/plugins/kafka-upstream/examples/schema-registry-simple-json/)
- [Example: Protected resource metadata](https://developer.konghq.com/plugins/openid-connect/examples/protected-resource-metadata/)
- [Example: Token exchange with an actor token](https://developer.konghq.com/plugins/openid-connect/examples/token-exchange-actor-token/)
- [Example: Add Principal attributes to metrics](https://developer.konghq.com/plugins/opentelemetry/examples/metrics-principal-attributes/)
- [Example: Cache by Principal](https://developer.konghq.com/plugins/proxy-cache-advanced/examples/cache-by-principal/)
- [Example: Cache by Principal](https://developer.konghq.com/plugins/proxy-cache/examples/cache-by-principal/)
- [Example: Rate limit by Principal metadata](https://developer.konghq.com/plugins/rate-limiting-advanced/examples/rate-limit-by-principal-metadata/)
- [Example: Rate limit by Principal metadata](https://developer.konghq.com/plugins/rate-limiting/examples/rate-limit-by-principal-metadata/)
- [Example: Log invalid requests without blocking](https://developer.konghq.com/plugins/request-validator/examples/tap-mode/)
- [Metrics PDK](https://developer.konghq.com/custom-plugins/metrics-pdk/)
- [Conditional expressions for plugins](https://developer.konghq.com/gateway/plugins/conditions/)
- [Dynamic plugin config with CEL](https://developer.konghq.com/gateway/plugins/expressible-fields/)
...
- [Identify AI Consumers on AI Model traffic with Kong Identity](https://developer.konghq.com/ai-gateway/identify-ai-consumers-with-kong-identity/)
- [Monetize AI Gateway traffic](https://developer.konghq.com/ai-gateway/meter-llm-traffic/)
- [Use AI PII Sanitizer plugin to protect sensitive data in responses](https://developer.konghq.com/ai-gateway/protect-sensitive-information-output-with-ai/)
- [Use AI PII Sanitizer to protect sensitive data in requests](https://developer.konghq.com/ai-gateway/protect-sensitive-information-with-ai/)

### Kong Gateway

- [Flush a public Dedicated Cloud Gateway managed cache using Terraform](https://developer.konghq.com/dedicated-cloud-gateways/flush-managed-cache/)
- [Straiker Coding Agent Buffered](https://developer.konghq.com/plugins/straiker-coding-agent-buffered/)
- [Straiker Coding Agent Streaming](https://developer.konghq.com/plugins/straiker-coding-agent-streaming/)
- [Straiker](https://developer.konghq.com/plugins/straiker/)

### Other

- [Run kongctl in Docker](https://developer.konghq.com/kongctl/docker/)
