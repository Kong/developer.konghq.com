...
- [Configure dynamic plugin config with CEL in Kong Gateway](https://developer.konghq.com/gateway/configure-dynamic-plugin-config-with-cel/)
...
- [Verify a Datakit call node's TLS connection using a custom CA](https://developer.konghq.com/how-to/verify-datakit-call-with-custom-ca/)
