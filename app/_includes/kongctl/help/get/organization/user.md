```ansi
Usage:
  kongctl get organization user [flags]
  kongctl get organization user [command]
...
Use "kongctl get organization user [command] --help" for more information about a command.
