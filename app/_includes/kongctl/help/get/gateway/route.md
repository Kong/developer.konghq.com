...
Examples:
  ...
  kongctl get konnect gateway routes --control-plane-id <id>
  # List all the Kong Gateway Routes for the a given Control Plane (by name)
  kongctl get konnect gateway routes --control-plane-name <name>
  # Get a specific Kong Gateway Routes located on the given Control Plane (by name)
  kongctl get konnect gateway route --control-plane-name <name> <route-name>
