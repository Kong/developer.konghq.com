```ansi
Usage:
  kongctl get konnect ai-gateway [flags]
  kongctl get konnect ai-gateway [command]
...
Use "kongctl get konnect ai-gateway [command] --help" for more information about a command.
