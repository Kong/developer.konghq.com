```ansi
Usage:
  kongctl list organization user [flags]
  kongctl list organization user [command]

Aliases:
  user, users, User, Users, USER, USERS

Available Commands:
  roles       List organization user role assignments
...
Use "kongctl list organization user [command] --help" for more information about a command.
