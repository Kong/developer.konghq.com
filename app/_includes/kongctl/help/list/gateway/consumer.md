...
Examples:
  ...
  kongctl get konnect gateway consumers --control-plane-id <id>
  # List all the Kong Gateway Consumers for the a given Control Plane (by name)
  kongctl get konnect gateway consumers --control-plane-name <name>
  # Get a specific Kong Gateway Consumers located on the given Control Plane (by name)
  kongctl get konnect gateway consumer --control-plane-name <name> <consumer-name>
