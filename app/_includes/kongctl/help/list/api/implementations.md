...
Aliases:
  implementations, implementation, impls, impl

Examples:
  # List implementations for an API by ID
  kongctl get api implementations --api-id <api-id>
  # List implementations for an API by name
  kongctl get api implementations --api-name my-api
  # Get a specific implementation by ID
  kongctl get api implementations --api-id <api-id> <implementation-id>
  # Get an implementation by service ID
  kongctl get api implementations --api-id <api-id> <service-id>
