```ansi
Usage:
  kongctl list ai-gateway certificates [certificate-id|name] [flags]

Aliases:
  certificates, certificate, cert, certs

Examples:
kongctl get ai-gateway certificates --gateway-id <gateway-id>
...
Flags:
      ...
      --certificate-id string     The ID of the AI Gateway runtime certificate to retrieve.
                                  - Config path: [ konnect.ai-gateway.certificate.id ]
      --certificate-name string   The name of the AI Gateway runtime certificate to retrieve.
                                  - Config path: [ konnect.ai-gateway.certificate.name ]
