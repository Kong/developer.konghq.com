```bash
Usage:
  kongctl delete gateway [command]
...
Additional help topics:
  kongctl delete gateway consumer Manage Konnect Kong Gateway Consumers
  kongctl delete gateway route Manage Konnect Kong Gateway Routes
  kongctl delete gateway service Manage Konnect Kong Gateway Services

Use "kongctl delete gateway [command] --help" for more information about a command.
