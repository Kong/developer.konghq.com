...
rows:
  ...
  - interval: "Last 90 days"
    aggregation_increment_frequency: "Daily, Weekly"
    notes: "Data is aggregated in daily or weekly increments."
  - interval: "Last 180 days"
    aggregation_increment_frequency: "Daily, Weekly"
    notes: "Data is aggregated in daily or weekly increments."
  - interval: "Last 365 days"
    aggregation_increment_frequency: "Weekly"
    notes: "Data is aggregated in weekly increments."
  - interval: "Current quarter"
    aggregation_increment_frequency: "Daily, Weekly"
    notes: "Logs any traffic in the current calendar quarter. Data is aggregated in daily or weekly increments."
  - interval: "Previous quarter"
    aggregation_increment_frequency: "Daily, Weekly"
    notes: "Logs any traffic in the previous calendar quarter. Data is aggregated in daily or weekly increments."
{% endtable %}
<!--vale on-->
