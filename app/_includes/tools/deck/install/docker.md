...
The official image is distroless, so it has no shell or package manager. If you need a shell inside the container, see [Build a non-distroless decK Docker image](/deck/build-non-distroless-docker-image/).
