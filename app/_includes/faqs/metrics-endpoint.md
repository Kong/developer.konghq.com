...
If you're using a third-party AI provider, like Claude or ChatGPT, you can use the {{site.konnect_short_name}} MCP Server or the [metrics API endpoint](/api/konnect/analytics-metrics/). 
