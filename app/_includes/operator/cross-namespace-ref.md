...
* `ReferenceGrant`: A standard [Kubernetes Gateway API resource](https://gateway-api.sigs.k8s.io/reference/api-types/referencegrant/) used for authorizing references from Gateway API resources to other resources.
