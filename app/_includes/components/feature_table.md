...
{% if include.compatibility_table %}{{include.item_title}} {{column.title}}{% else %}{{column.title}}{% endif %}: {% if value == true %}Supported{% elsif value == false %}Not Supported{% else %}{{ value | liquify}}{% endif %}
{% endfor -%}
{% endfor %}