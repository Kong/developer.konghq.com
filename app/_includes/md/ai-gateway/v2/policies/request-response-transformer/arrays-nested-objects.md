The Policy allows navigating complex JSON objects (arrays and nested objects)
...
These can be combined. For example, `config.remove.body: customers[*].info.phone` removes
