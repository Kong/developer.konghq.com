...
1. Once deployed, export the following environment variables:
    ...
    {:.warning}
    > `AZURE_AI_FOUNDRY_UPSTREAM_URL` must end at `/anthropic` — don't append `/v1/messages`. {{site.ai_gateway}} appends the rest of the Anthropic Messages API path automatically.
