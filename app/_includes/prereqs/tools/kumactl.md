...
1. Add the {{site.mesh_product_name}} binaries directory to your path. By default, the directory is `/{{site.mesh_product_name_path}}-{{page.latest_release.version}}/bin`. You can use the following command to set the directory in your path for the **current** terminal window:
