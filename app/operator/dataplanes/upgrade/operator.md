...
1. Read the [chart changelog](https://github.com/Kong/charts/blob/main/charts/kong-operator/CHANGELOG.md) for every chart version between your currently used version and the one including the bump to the target operator version.
