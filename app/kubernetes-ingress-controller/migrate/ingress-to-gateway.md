...
tldr:
  q: How can I migrate from Ingress to Gateway API?
  a: By using the `kubernetes-sigs/ingress2Gateway`` CLI tool, you can convert Ingress API resources (including TCPIngress and UDPIngress) to the Gateway API
