---
title: Conditional expressions for plugins in {{site.base_gateway}} 3.14
...
> Conditional expressions in plugin versions 3.14 and lower is a Beta feature and should not be used in production deployments.
