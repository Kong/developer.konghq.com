---
title: "{{site.base_gateway}} 3.10 to 3.14 LTS upgrade"
...
description: This guide walks you through upgrade paths for {{site.base_gateway}} 3.10 LTS to 3.14 LTS and helps you prepare for an upgrade.
...
related_resources:
  ...
  - text: "Convert Gateway entity configuration from 3.10 to 3.14"
...
{% include_cached /upgrade/lts-upgrade.md lts_version_from='3.10' lts_version_to='3.14' %}