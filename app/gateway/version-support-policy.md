...
{% include_cached /policies/support-policy.md %}
...
{:.info}
> **Note:** This policy **only** applies to {{site.base_gateway}} and {{site.ee_product_name}}. For {{site.konnect_short_name}}, review the [{{site.konnect_short_name}} version support policy](/konnect/compatibility/#kong-gateway-version-compatibility).
