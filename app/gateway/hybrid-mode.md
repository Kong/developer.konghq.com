...
Control Plane. The Control Plane listens on port [`8005` ({{site.base_gateway}})](/gateway/network/) or [`443` ({{site.konnect_short_name}})](/konnect/network/) for connections and
