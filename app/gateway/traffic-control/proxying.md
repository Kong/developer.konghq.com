...
You can also use `advanced_latency_tokens` to expose more detailed timing headers, such as total latency, third-party latency, and client latency. For more information, see the [Kong configuration reference](/gateway/configuration/#advanced_latency_tokens).
{% endif_version %}
