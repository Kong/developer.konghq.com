...
The default value of the [`dns_no_sync`](/gateway/configuration/#dns_no_sync) option has been changed to `on` for 3.5.0.0 and 3.5.0.1. As of 3.5.0.2, the default value has been changed to `off`. 
...
You can migrate from Cassandra DB to PostgreSQL by following the [migration guide](/gateway/upgrade/cassandra-migration/), 
...
[build your own Docker images](/how-to/build-custom-images).
