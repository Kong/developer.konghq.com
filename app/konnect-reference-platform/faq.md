...
The `teams` configuraton defines the engineering group's developer teams and their application repositories. Every team defined 
...
meatadata, and access control policies.
...
maps that to opinionated configurations for the Konnect resources it mananges. The following shows the general configuration
...
Kong Konnect's design centers around the concept of an organization. An organization is an isolated tenant of Konnect resources with 
...
* Data between organizations is isolated, limiting the ability of Konnect appliations to provide visbility into the full usage of the platform
...
* One organization allows Konnect applications full visbility across your businesses usage of the platform enabling deeper insights, analytics, and capabilities
...
* Single organization can eliminate redundant configuration of key shared resources such as network settings, authorization integrations, 
