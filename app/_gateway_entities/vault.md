...
> * <sup>2</sup>: For the same reasons of secret being resolve at the Konnect level, it is currently not possible to use Konnect Config Store secrets directly in Lua code via the Kong PDK, for example.
