...
You can generate a CSV report about active and inactive users by clicking the download button next to **Last Active** in the [Licenses](https://app.insomnia.rest/app/enterprise/licenses) page, for the last 7, 30, or 90 days.
This report contains:

- The date at which each user last opened Insomnia.
- The number of requests the user made.
- The number of documents de user created. 
