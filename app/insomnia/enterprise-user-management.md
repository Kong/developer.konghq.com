...
{% new_in 13.2 %} This report can be filtered by the last 7, 30, or 90 days. 

Each report contains:

- The date at which each user last opened Insomnia.
- {% new_in 13.2 %} The number of requests the user made.
- {% new_in 13.2 %} The number of documents the user created. 
