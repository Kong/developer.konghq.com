...
Each report includes the date each user last used Insomnia in the last 7, 30, or 90 days. Tracked activity includes creating and sending requests and creating API Collections.
