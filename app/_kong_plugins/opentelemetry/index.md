...
Two different kinds of logs are exported: **Request** and **Non-Request** scoped.
  ...
  * Non-request logs aren't directly associated with a request. They're produced outside the request lifecycle. For example, this could be logs generated asynchronously (in a timer) or during a worker's startup.
