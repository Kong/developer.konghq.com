...
{:.note .no-icon}
> **\[1\]**: Only when `sync_rate` option is set to `0` (synchronous behavior). See the [configuration reference](/plugins/rate-limiting-advanced/reference/#config-sync_rate) for more details.
