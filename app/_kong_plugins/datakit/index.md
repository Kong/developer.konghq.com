...
rows:
  ...
  - nodetype: |
    ...
    description: "Transform JSON or a Lua table into XML."
    inputs: JSON string or table
    outputs: XML document converted from JSON
  - nodetype: |
      [`xml_to_json`](#xml-to-json-node) {% new_in 3.13 %}
    description: "Transform XML into JSON or a Lua table."
    inputs: XML document
    outputs: JSON string or table
{% endtable %}
<!--vale on-->
