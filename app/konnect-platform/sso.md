...
* For for OIDC authentication, you should add an additional sign-in redirect URI set to to the Kong-managed {{site.konnect_short_name}} Portal Editor Preview domain: `https://$YOUR_SUBDOMAIN.us.kongportals.com/login`
