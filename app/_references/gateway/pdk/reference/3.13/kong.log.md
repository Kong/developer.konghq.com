 ...
 * `latencies` - request/proxy latencies. The following fields may be present:
     * `kong` - Time spent processing inside Kong (in ms), excluding upstream but including third-party I/O.
