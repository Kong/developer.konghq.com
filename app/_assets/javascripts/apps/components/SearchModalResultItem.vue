<template>
  <div class="flex w-full">
    <a :href="relativeUrl" class="flex gap-3 w-full p-3 rounded-md bg-primary border border-primary shadow-primary hover:no-underline hover:border-brand-saturated hover:shadow-hover-card  focus:border-brand-saturated focus:shadow-hover-card" tabindex="0">
