<template>
  <div class="flex w-full">
    <a :href="relativeUrl" class="flex gap-3 w-full p-3 rounded-md bg-primary border border-primary/5 shadow-primary hover:no-underline hover:border-brand-saturated/40 hover:shadow-hover-card  focus:border-brand-saturated/40 focus:shadow-hover-card">
