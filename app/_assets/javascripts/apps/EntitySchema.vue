...
<style scoped>
:deep(code) {
  @apply bg-secondary rounded border border-links/40 text-xs py-0 px-1 !important;
}

:deep(.property-field-default-value) {
  @apply bg-secondary rounded border border-links/40 text-xs py-0 px-1 shadow-none !important;
}
