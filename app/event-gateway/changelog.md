...
See the [breaking changes entry for metrics naming](/event-gateway/breaking-changes/#metrics-naming-convention) for more details.
...
use in authorization policies.
  - [How-to: Configure mTLS client authentication with {{site.event_gateway}}](/event-gateway/configure-mtls-client-authentication/)
...
control per topic.
  - [How-to: Set up {{site.event_gateway}} with Kong Identity OAuth](/event-gateway/kong-identity-oauth)
  - [ACL policy reference](/event-gateway/policies/acl/)
