...
Total time {{site.base_gateway}} spends processing a Gen AI operation, such as an LLM request. {{site.base_gateway}} acts as the client calling the Gen AI provider.
...
rows:
  ...
  - attr: "`error.type`"
    desc: "Error type, if the request failed. Requires `enable_request_metrics`."
{% endtable %}
<!-- vale on -->
...
**Attributes:** Same as [`gen_ai.client.operation.duration`](#gen_aiclientoperationduration).
...
rows:
  ...
  - attr: "`gen_ai.response.model`"
    desc: "Model name reported by the provider in the response."
  - attr: "`gen_ai.token.type`"
    desc: "Token category: `input`, `output`, or `total`."
  - attr: "`gen_ai.operation.name`"
    desc: "Operation requested, such as `chat` or `embeddings`."
  - attr: "`kong.workspace.name`"
    desc: "Name of the Workspace."
...
**Attributes:** Same as [`gen_ai.server.time_to_first_token`](#gen_aiservertime_to_first_token).
