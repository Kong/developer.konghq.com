...
For an example, see [`app/_includes/prereqs/gemini.md`](https://github.com/Kong/developer.konghq.com/blob/main/app/_includes/prereqs/gemini.md), which walks users through getting a {{ site.gemini }} API key from {{ site.google_cloud }} before the main tutorial begins.
