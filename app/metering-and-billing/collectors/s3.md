...
{{site.metering_and_billing}} can ingest data from an S3-compatible object storage, making integration easier with existing data pipelines. Examples of popular S3-compatible object stores:
