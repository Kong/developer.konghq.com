...
The above section tells Redpanda Connect to read data from your S3 bucket in the specified region and look for objects in the specified prefix (hourly timestamp). You will have to run the collector as a cron job every hour to ingest the data into {{site.metering_and_billing}}. Adjust the prefix for your needs.
