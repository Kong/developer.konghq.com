...
{:.success}
> **Get started with the {{site.konnect_short_name}} MCP Server**: Use the [{{site.konnect_short_name}} MCP Server](/konnect-platform/konnect-mcp/) and the [VS Code extension](https://marketplace.visualstudio.com/items?itemName=konghq.vscode-konnect-dev-portal-toolkit) to create and edit {{site.dev_portal}} pages, snippets, and [Markdown Components (MDC)](https://portaldocs.konghq.com/) directly from your AI assistant or IDE.
