...
{% navtab "{{site.konnect_short_name}} UI" %}
Navigate to [**Catalog > APIs**](https://cloud.konghq.com/apis) in the sidebar and click your API. 
Click the **Documentation** tab, and then click **New document** to create a new Markdown document. 

If you want to upload a Markdown documentation file, use the API or Terraform.
{% endnavtab %}
{% navtab "{{site.konnect_short_name}} API" %}
