...
{:.warning}
> This policy doesn't work with sidecars without [transparent-proxy](/mesh/v2/transparent-proxying/).
...
* It isn't possible to route passthrough traffic through the [zone egress](/mesh/v2/zone-egress/#zone-egress).
