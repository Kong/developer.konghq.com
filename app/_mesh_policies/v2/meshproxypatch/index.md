...
products:
    - mesh
description: "Configuration low-level options for Envoy resources that {{site.mesh_product_name}} policies do not directly expose."
content_type: plugin
type: policy
...
> Do **not** combine with the deprecated Proxy Template policy.
