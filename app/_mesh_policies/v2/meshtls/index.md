...
> If you want to try out a specific version/cipher combination, we recommend creating a [temporary mesh](/mesh/v2/mesh-multi-tenancy/), deploying two applications within it, and testing whether communication is working.
