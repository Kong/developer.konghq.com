...
See [Testing regional failover](/dedicated-cloud-gateways/cross-regional-failover-testing/) for the complete test procedure, plugin configuration, test matrix, and Route 53 health check parameters.