...
Export your environment variables. The defaults below pin to Sonnet 4.5 and Opus 4.5, the canonical stable Claude versions in Foundry's Model catalog. The alias values are also the Foundry deployment names you configured in the **AI Credentials** prerequisites:
