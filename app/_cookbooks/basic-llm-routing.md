...
Export the model env vars. The model names are recorded by Kong in the `X-Kong-LLM-Model` header for analytics, but Azure's upstream selection is driven by the deployment IDs you exported in the AI Credentials prerequisite:
