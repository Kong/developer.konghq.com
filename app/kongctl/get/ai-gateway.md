...
rows:
  - command: |
      [kongctl get ai-gateway agents](/kongctl/get/ai-gateway/#kongctl-get-ai-gateway-agents)
    description: "Use the `agents` command to list or retrieve Agents for a specific {{site.konnect_short_name}} {{site.ai_gateway}}."
  - command: |
      [kongctl get ai-gateway consumer-groups](/kongctl/get/ai-gateway/#kongctl-get-ai-gateway-consumer-groups)
  ...
  - command: |
      [kongctl get ai-gateway consumers](/kongctl/get/ai-gateway/#kongctl-get-ai-gateway-consumers)
  ...
  - command: |
      [kongctl get ai-gateway credentials](/kongctl/get/ai-gateway/#kongctl-get-ai-gateway-credentials)
  ...
  - command: |
      [kongctl get ai-gateway data-plane-certificates](/kongctl/get/ai-gateway/#kongctl-get-ai-gateway-data-plane-certificates)
  ...
  - command: |
      [kongctl get ai-gateway identity-providers](/kongctl/get/ai-gateway/#kongctl-get-ai-gateway-identity-providers)
  ...
  - command: |
      [kongctl get ai-gateway mcp-servers](/kongctl/get/ai-gateway/#kongctl-get-ai-gateway-mcp-servers)
  ...
  - command: |
      [kongctl get ai-gateway model-providers](/kongctl/get/ai-gateway/#kongctl-get-ai-gateway-model-providers)
  ...
  - command: |
      [kongctl get ai-gateway models](/kongctl/get/ai-gateway/#kongctl-get-ai-gateway-models)
    description: "Use the `models` command to list or retrieve models for a specific {{site.konnect_short_name}} {{site.ai_gateway}}."
  - command: |
      [kongctl get ai-gateway nodes](/kongctl/get/ai-gateway/#kongctl-get-ai-gateway-nodes)
  ...
  - command: |
      [kongctl get ai-gateway policies](/kongctl/get/ai-gateway/#kongctl-get-ai-gateway-policies)
    description: "Use the `policies` command to list or retrieve Policies for a specific {{site.konnect_short_name}} {{site.ai_gateway}}."
  - command: |
      [kongctl get ai-gateway vaults](/kongctl/get/ai-gateway/#kongctl-get-ai-gateway-vaults)
