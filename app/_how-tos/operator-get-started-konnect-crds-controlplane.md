...
content_type: how_to
permalink: /operator/get-started/konnect-crds/control-plane/
breadcrumbs:
  - /operator/
  - index: operator
    group: Konnect
...
A `KonnectAPIAuthConfiguration` must already exist to authenticate with the Konnect API. If you haven’t created one yet, see [Create API Authentication](/operator/get-started/authentication/).
