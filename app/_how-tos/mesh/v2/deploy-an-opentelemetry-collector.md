...
content_type: how_to
permalink: /mesh/v2/deploy-an-opentelemetry-collector/
...
faqs:
  ...
  - q: How do I run the collector as a Deployment instead?
    a: |
      Use a Deployment for small and medium clusters, or any cluster where collector throughput isn't a bottleneck. See [OpenTelemetry collector topologies](/mesh/v2/observability/#topologies) for the trade-offs.
