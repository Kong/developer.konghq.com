...
content_type: how_to
permalink: /mesh/v2/configure-inbound-traffic-rules-api/
...
1. Create a namespace with [sidecar injection](/mesh/v2/concepts/#data-plane-proxy-sidecar) for the client that communicates with the demo app:
