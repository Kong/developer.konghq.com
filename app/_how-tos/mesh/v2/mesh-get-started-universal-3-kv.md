...
content_type: how_to
permalink: /mesh/v2/get-started/universal/kv/
breadcrumbs:
  - /mesh/v2/
products:
  - mesh
...
1. Install the required tools:
   ...
   * `iptables`: Configures the [transparent proxy](/mesh/v2/transparent-proxying/).
...
To confirm the service is set up correctly and running, use [kumactl](/mesh/v2/cli/) to inspect the `MeshService` resources:
