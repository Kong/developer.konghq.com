...
content_type: how_to
permalink: /mesh/v2/get-started/universal/install/
breadcrumbs:
  - /mesh/v2/
related_resources:
...
Set up a temporary directory to store resources like data plane tokens, [`Dataplane`](/mesh/v2/data-plane-proxy/) templates, and logs. Ensure the path does not end with a trailing `/`.
...
Create a reusable [`Dataplane`](/mesh/v2/data-plane-proxy/) resource template for services:
