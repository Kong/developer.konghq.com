...
content_type: how_to
permalink: /mesh/v2/get-started/universal/control-plane/
breadcrumbs:
  - /mesh/v2/
products:
  - mesh
...
To manage the deployment with [kumactl](/mesh/v2/cli/), connect it to the control plane you started in the previous section.
...
Configure the default mesh to use [`MeshService`](/mesh/v2/meshservice/) resources in [Exclusive mode](/mesh/v2/meshservice/#exclusive):
...
`MeshService` resources are explicit representations of traffic destinations. They define which [data plane proxies](/mesh/v2/data-plane-proxy/) serve the traffic and the available ports, IPs, and hostnames.