...
content_type: how_to
permalink: /mesh/v2/zone-proxies/
breadcrumbs:
  - /mesh/v2/
related_resources:
...
> For production, follow the [`MeshIdentity` guide](/mesh/v2/issue-identity-with-meshidentity-spire/) to integrate a SPIRE trust domain or an external CA.
