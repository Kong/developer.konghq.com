...
content_type: how_to
permalink: /mesh/v2/use-cert-manager-for-control-plane-certificates/
products:
  - mesh
works_on:
  - on-prem
...
cleanup:
  inline:
    - title: Clean up {{site.mesh_product_name}}
      include_content: cleanup/products/mesh/v2
related_resources:
  - text: Deploy Mesh on Kubernetes
    url: /mesh/v2/deploy-mesh-on-kubernetes/
  - text: Deploy Mesh (self-managed)
    url: /mesh/v2/deploy-mesh-self-managed/
