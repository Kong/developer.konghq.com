    ...
    models:
      - ref: codex-openai
        ...
        config:
          ...
          model: { alias: gpt-4o, name_header: true }
 ...
 * `config.model.alias: gpt-4o`: The model name the Codex CLI sends in each request.
...
curl -sS http://localhost:8000/codex/responses \
  ...
  -d '{"model":"gpt-4o","input":"Reply with just: ok","max_output_tokens":16}'
```
