...
permalink: /ai-gateway/v1/how-to/use-claude-code-with-ai-gateway-azure/
content_type: how_to
...
First, configure the AI Proxy plugin for the [Azure AI provider](/ai-gateway/v1/ai-providers/#azure-ai):
