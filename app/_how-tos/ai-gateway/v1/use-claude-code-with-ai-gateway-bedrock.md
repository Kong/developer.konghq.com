...
permalink: /ai-gateway/v1/how-to/use-claude-code-with-ai-gateway-bedrock/
content_type: how_to
...
Configure the AI Proxy plugin for the [AWS Bedrock provider](/ai-gateway/v1/ai-providers/#bedrock).
