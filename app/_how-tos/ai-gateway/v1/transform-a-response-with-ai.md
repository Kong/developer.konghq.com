...
permalink: /ai-gateway/v1/how-to/transform-a-response-with-ai/
content_type: how_to
related_resources:
...
tldr:
    ...
    a: Enable the [AI Response Transformer](/ai-gateway/v1/how-to/transform-a-response-with-ai/) plugin, configure the parameters under `config.llm` to access your LLM and describe the transformation to perform with the `config.prompt` parameter.
