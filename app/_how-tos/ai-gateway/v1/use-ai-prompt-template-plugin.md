...
permalink: /ai-gateway/v1/how-to/use-ai-prompt-template-plugin/
content_type: how_to
related_resources:
...
The plugin will automatically [block all untemplated requests](/ai-gateway/v1/how-to/use-ai-prompt-template-plugin/#denied-prompts) via `allow_untemplated_requests: false` setting.
