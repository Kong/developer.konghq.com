...
permalink: /ai-gateway/v1/how-to/use-claude-code-with-ai-gateway-gemini/
content_type: how_to
...
First, configure the AI Proxy plugin for the [{{ site.gemini }} provider](/ai-gateway/v1/ai-providers/#gemini):
