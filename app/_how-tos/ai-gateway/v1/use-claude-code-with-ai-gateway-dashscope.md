...
permalink: /ai-gateway/v1/how-to/use-claude-code-with-ai-gateway-dashscope/
content_type: how_to
...
This output confirms that {{ site.claude_code }} routed the request through {{site.ai_gateway}} using DashScope with the `qwen-plus` model.