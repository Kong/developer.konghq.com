...
permalink: /ai-gateway/v1/how-to/use-claude-code-with-ai-gateway-huggingface/
content_type: how_to
...
Configure the AI Proxy plugin for the [HuggingFace provider](/ai-gateway/v1/ai-providers/#huggingface). This setup uses the default `llm/v1/chat` route. {{ site.claude_code }} sends its requests to this route.
