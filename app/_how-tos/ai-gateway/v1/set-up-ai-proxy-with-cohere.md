...
permalink: /ai-gateway/v1/how-to/set-up-ai-proxy-with-cohere/
...
To set up AI Proxy with {{ site.cohere }}, configure API key authentication and specify the {{ site.cohere }} model to use. 
