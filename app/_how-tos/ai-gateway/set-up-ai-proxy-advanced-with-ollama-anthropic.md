---
title: Set up AI Proxy Advanced with Ollama and an Anthropic model
permalink: /how-to/set-up-ai-proxy-advanced-with-ollama-anthropic/
content_type: how_to
related_resources:
...
tldr:
  q: How do I use the AI Proxy Advanced plugin with Ollama and an Anthropic model?
