...
This output confirms that {{ site.claude}} Code routed the request through {{site.ai_gateway}} using AWS Bedrock with the `us.anthropic.claude-haiku-4-5-20251001-v1:0` model.

## Troubleshooting

When using {{ site.claude}} Code with AWS Bedrock models, you may encounter connection errors.
