...
tldr:
  ...
  a: Replace the `base_url` in your Agno model configuration with your Kong AI Gateway Route URL to proxy requests through Kong and apply AI Gateway plugins.
