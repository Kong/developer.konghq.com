...
tldr:
  q: How do I configure a custom LLM endpoint in Insomnia?
  a: Open **Preferences** > **AI**, select **LLM URL**, enter your OpenAI-compatible endpoint, load available models, and select the model that you want to use.
---
...
Insomnia sends AI requests to the configured endpoint.
