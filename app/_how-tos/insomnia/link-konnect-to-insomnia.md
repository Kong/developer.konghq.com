---
title: Link a {{ site.konnect_short_name }} Service to {{ site.insomnia }} 
...
description: Link {{ site.insomnia }} to {{ site.konnect_short_name }} and send requests against a Route in your {{site.base_gateway}} Service.
tags:
  - konnect
  - integrations
prereqs:
...
breadcrumbs:
  - /insomnia/
related_resources:
  - text: "{{ site.konnect_short_name }} integration in {{ site.insomnia }}"
...
tldr:
  q: How do I use {{ site.insomnia }} to send requests against a route hosted on {{ site.konnect_short_name }}?
  a: In {{ site.insomnia }}, link {{ site.konnect_short_name }} using a [Personal Access Token (PAT)](/konnect-api/#personal-access-tokens) and set up proxy URLs for your Gateway Service.  
---

## Link {{ site.insomnia }} to {{ site.konnect_short_name }}
...
{{ site.insomnia }} never resets this setup when syncing. If you change the proxy URLs in {{ site.konnect_short_name }}, repeat this setup.

You are now ready to send requests from {{ site.insomnia }} against Routes hosted on {{ site.konnect_short_name }}.
...
In the **Preview** tab, {{ site.insomnia }} displays the following response:
