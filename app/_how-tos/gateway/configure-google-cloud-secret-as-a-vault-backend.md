...
To validate that the secret was stored correctly in {{ site.google_cloud }}, you can call a secret from your vault using the `kong vault get` command within the Data Plane container. 
