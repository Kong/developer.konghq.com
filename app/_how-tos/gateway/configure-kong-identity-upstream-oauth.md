---
title: Configure the Upstream OAuth plugin with {{site.identity}}
...
tags:
    - authentication
description: Learn how to configure {{site.identity}} with Upstream OAuth.

tldr: 
  q: How do I configure {{site.identity}} with Upstream OAuth?
  a: | 
...
You can configure the [Upstream OAuth plugin](/plugins/upstream-oauth/) to use {{site.identity}} as the identity provider for your Gateway Services. In this example, you'll apply the plugin to the control plane globally, but you can alternatively apply it to a Gateway Service.
