---
title: Configure the OAuth 2.0 Introspection plugin with {{site.identity}}
...
tags:
    - authentication
description: Learn how to configure {{site.identity}} with OAuth 2.0 Introspection.

tldr: 
  q: How do I configure {{site.identity}} with OAuth 2.0 Introspection?
  a: | 
...
You can configure the [OAuth 2.0 Introspection plugin](/plugins/oauth2-introspection/) to use {{site.identity}} as the identity provider for your Gateway Services. In this example, you'll apply the plugin to the control plane globally, but you can alternatively apply it to a Gateway Service.
