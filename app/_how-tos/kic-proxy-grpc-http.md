...
Annotate the `grpcbin` Service you you installed in the [prerequisites](#prerequisites) with `grpc` to inform {{site.base_gateway}} that this service is a gRPC (with TLS) service and not a HTTP service:
