...
description: "Learn how to configure an Azure managed cache for a Dedicated Cloud Gateway control plane."
breadcrumbs:
...
tldr:
  q: How do I configure an Azure managed cache for my Dedicated Cloud Gateway control plane?
  a: |
