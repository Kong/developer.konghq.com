---
title: Resolving the LLM route chat type error
content_type: support
description: How to fix the the LLM route chat type error error by sending the correct Content-Type header to {{site.base_gateway}}.
products:
  - gateway
  - ai-gateway
works_on:
