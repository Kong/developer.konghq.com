---
title: "Error: 'Invalid Nginx Configuration' when enabling nginx_proxy_brotli in kong.conf"
content_type: support
description: "When configuring `nginx_proxy_brotli` in your `kong.conf` file, you might encounter an error that prevents successful deployment, stating that the Nginx configuration is invalid."
products:
  - gateway
works_on:
  - on-prem
