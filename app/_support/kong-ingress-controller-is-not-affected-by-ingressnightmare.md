...
description: "{{site.kic_product_name}} (KIC) is not impacted or affected by the vulnerability \"IngressNightmare\"."
products:
  - gateway
works_on:
  - on-prem
  - konnect
tldr:
  q: Is {{site.kic_product_name}} affected by the IngressNightmare vulnerability?
  a: |
