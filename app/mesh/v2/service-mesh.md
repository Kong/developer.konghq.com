...
* You can delegate the network management to something else that does it for you. For example, an out-of-process proxy that runs on the same underlying host. This proxy is called a [data plane proxy](/mesh/v2/data-plane-proxy/), or sidecar.
