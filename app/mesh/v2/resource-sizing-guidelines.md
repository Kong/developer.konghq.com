...
For any large mesh using a transparent proxy, we recommend using [reachable services](/mesh/v2/performance-tuning/#reachable-services).

You can also find tuning configuration in the [performance fine-tuning](/mesh/v2/performance-tuning/) documentation.
...
Check the [`ContainerPatch` documentation](/mesh/v2/data-plane-kubernetes/#workload-matching) to learn how to apply these resources to specific pods.
