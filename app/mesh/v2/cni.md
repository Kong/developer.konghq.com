...
The recommended way of accomplishing this is via [transparent proxying](/mesh/v2/transparent-proxying/).
...
You can install the CNI using either [kumactl](/mesh/v2/#install-kong-mesh) or [Helm](https://helm.sh/).
