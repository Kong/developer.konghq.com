...
server.
* [`acmpca`](/mesh/v2/acm-private-ca-policy/): {{site.mesh_product_name}} generates Data Plane certificates
using {{ site.amazon }} Certificate Manager Private CA.
* [`certmanager`](/mesh/v2/cert-manager/): {{site.mesh_product_name}} generates Data Plane certificates
