...
* In a multi-zone deployment, all requests sent from local data plane proxies to other zones will be directed through the local zone egress instance, which will then direct the traffic to the proper instance of the [zone ingress](/mesh/v2/zone-ingress/).
