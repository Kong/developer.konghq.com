...
{:.info}
> By default cross-zone connectivity requires [mTLS](/mesh/v2/policies/mutual-tls/) to be enabled on the [mesh](/mesh/v2/mesh-multi-tenancy/) with the appropriate [MeshTrafficPermission](/mesh/policies/meshtrafficpermission/) to enable the flow of traffic. Otherwise, unsecured traffic won't be permitted outside each zone.
