...
Policies in {{ site.mesh_product_name }} let you declare how traffic and workloads should behave, instead of configuring each [data plane proxy](/mesh/v2/data-plane-proxy/) manually.
