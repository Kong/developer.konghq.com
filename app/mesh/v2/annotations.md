...
related_resources:
  ...
  - text: MeshMultiZoneService
    url: /mesh/v2/meshmultizoneservice/
...
For more information about how to use `ContainerPatch`, see [Custom container configuration](/mesh/v2/data-plane-kubernetes/#custom-container-configuration).
...
For more information, see [Data plane on Kubernetes](/mesh/v2/data-plane-kubernetes/#waiting-for-the-data-plane-to-be-ready).
...
Defines the port to use for [IPv6](/mesh/v2/ipv6-support/) traffic. To turn off IPv6, set this to 0.
...
It can be changed using [the control plane configuration](/mesh/v2/reference/kuma-cp/) or `KUMA_RUNTIME_KUBERNETES_INJECTOR_SIDECAR_CONTAINER_DRAIN_TIME` env.
