...
To obtain a configuration from the control plane, a zone proxy ([zone ingress](/mesh/v2/zone-ingress/) or [zone egress](/mesh/v2/zone-egress/)) must authenticate itself.
