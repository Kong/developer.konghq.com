...
In this guide, you will learn how to get {{site.mesh_product_name}} up and running quickly in [standalone mode](/mesh/v2/single-zone/) on [Red Hat OpenShift](https://www.redhat.com/technologies/cloud-computing/openshift). This tutorial assumes some base-level OpenShift knowledge.
...
In this step, you'll deploy the [`kuma-demo` app](/mesh/v2/kubernetes/) to {{site.mesh_product_name}}. This allows you to quickly populate your mesh with Services so you can test the capabilities of {{site.mesh_product_name}}.
...
* [Deploy a standalone Control Plane](/mesh/v2/single-zone/)
* [Deploy a multi-zone global Control Plane](/mesh/v2/mesh-multizone-service-deployment/)
