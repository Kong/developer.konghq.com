...
related_resources:
  ...
  - text: 'Secure access across services'
    url: '/mesh/v2/secure-access/'
  - text: Configure zone proxy authentication
    url: /mesh/v2/zone-proxy-auth/
major_version:
  mesh: 2
...
Kubernetes itself doesn't bound the Service Account Token to a mesh. For information on restricting which Pods can join a mesh, see [data plane proxy membership](/mesh/v2/configure-data-plane-proxy-membership/).
