...
{:.info}
> This section is not to be confused with the [mTLS policy](/mesh/v2/policies/mutual-tls/) that you can apply to a [Mesh](/mesh/v2/mesh-multi-tenancy/) to secure service-to-service traffic.

## Data plane proxy to control plane communication

A [data plane proxy](/mesh/v2/data-plane-proxy/) connects to the control plane to fetch its configuration, including mTLS certificates.
...
See [Data plane proxy authentication](/mesh/v2/data-plane-proxy-authentication/) and [Zone proxy authentication](/mesh/v2/zone-proxy-auth/).
...
See [API Server authentication](/mesh/v2/authentication-with-the-api-server/).
