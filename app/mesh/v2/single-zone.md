...
A single-zone deployment is the default deployment mode for {{site.mesh_product_name}}. 
In this mode, there is one deployment of the control plane that can be scaled horizontally. 
...
You can then [federate](/mesh/v2/federate-zone-control-plane-to-konnect/) it into a [multi-zone deployment](/mesh/v2/mesh-multizone-service-deployment/).
...
To avoid these limitations, see [Multi-zone deployments](/mesh/v2/mesh-multizone-service-deployment/).
