...
### Encrypted communication {#dpp-to-cp-encrypted-comm}
...
#### Override autogenerated certificates {#dpp-to-cp-override}
...
### Encrypted communication {#user-to-cp-encrypted-comm}

The API Server HTTPS server is secured by default by autogenerated certificates.

#### Override autogenerated certificates {#user-to-cp-override}

1. Prepare certificates:

{{certificate | indent: 3}}

2. Configure the control plane with the generated certificates
{% navtabs "user-to-cp" %}
{% navtab "Kubernetes" %}
...
3. Configure the secure connection using the `kumactl` CLI:
  ```sh
...
### Authentication {#user-to-cp-auth}
...
### Encrypted communication {#cp-to-cp-encrypted-comm}
...
#### Override autogenerated certificates {#cp-to-cp-override}

1. Prepare certificates:

{{certificate | indent: 3}}

2. Configure the global control plane

{% navtabs "cp-to-cp-global" %}
{% navtab "Kubernetes" %}
