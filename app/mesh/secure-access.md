...
Now you can configure {{site.mesh_product_name}}'s Prometheus SD with the correct TLS configuration using the [Prometheus docs](https://prometheus.io/docs/prometheus/latest/configuration/configuration/#kuma_sd_config).
...
{:.info}
> Third-party extensions, cloud implementations or [commercial offerings](/mesh/) may be extending the authentication support.
